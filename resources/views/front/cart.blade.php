            ...
            <div class="ps-cart-listing">
                <table class="table ps-cart__table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a class="ps-product__preview" href="{{ route('product.details' ,$item->product->slug) }}"><img class="mr-15" src="{{ $item->product->image_url }}" width="90" alt="">{{ $item->product->name }}</a></td>
